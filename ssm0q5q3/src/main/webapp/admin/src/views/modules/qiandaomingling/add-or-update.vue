<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签到课程" prop="qiandaokecheng">
          <el-input v-model="ruleForm.qiandaokecheng" 
              placeholder="签到课程" clearable  :readonly="ro.qiandaokecheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签到课程" prop="qiandaokecheng">
              <el-input v-model="ruleForm.qiandaokecheng" 
                placeholder="签到课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qiandaomingling/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qiandaominglingCrossAddOrUpdateFlag = false;
						 this.parent.search();
