<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出勤人数" prop="chuqinrenshu">
          <el-input v-model="ruleForm.chuqinrenshu" 
              placeholder="出勤人数" clearable  :readonly="ro.chuqinrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出勤人数" prop="chuqinrenshu">
              <el-input v-model="ruleForm.chuqinrenshu" 
                placeholder="出勤人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缺勤人数" prop="queqinrenshu">
          <el-input v-model="ruleForm.queqinrenshu" 
              placeholder="缺勤人数" clearable  :readonly="ro.queqinrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缺勤人数" prop="queqinrenshu">
              <el-input v-model="ruleForm.queqinrenshu" 
                placeholder="缺勤人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="到课率" prop="daokelv">
          <el-input v-model="ruleForm.daokelv" 
              placeholder="到课率" clearable  :readonly="ro.daokelv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="到课率" prop="daokelv">
              <el-input v-model="ruleForm.daokelv" 
                placeholder="到课率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chuqinqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chuqinqingkuangCrossAddOrUpdateFlag = false;
						 this.parent.search();
